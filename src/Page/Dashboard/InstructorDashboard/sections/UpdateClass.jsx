...
const UpdateClass = () => {
	...
	const updatableClass = useLoaderData();
	...
	const onSubmit = (e) => {
		...
		const postClass = async () => {
			const res = await secureAxios.put(`/class`, classObj);
			if (res.data.insertedId) {
				Swal.fire({
					icon: "success",
					title: "Your Class is successfully updated",
	...
	return (
		<div className=" max-w-6xl mx-auto flex-col lg:flex-row gap-16">
			<div className="card flex-shrink-0 max-w-6xl">
